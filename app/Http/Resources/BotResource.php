...
class BotResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        $allFields = [
            ...
            'about_to_end_time_minutes' => $this->about_to_end_time_minutes,
            'about_to_end_action' => $this->about_to_end_action,
            'about_to_end_message' => $this->about_to_end_message,
            'about_to_end_assign_bot_id' => $this->about_to_end_assign_bot_id,
            'about_to_end_assign_user_id' => $this->about_to_end_assign_user_id,
